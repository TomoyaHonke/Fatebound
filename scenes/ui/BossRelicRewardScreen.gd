...
class _BossRelicCard extends Control:
	...
	func _build_labels() -> void:
		...
		name_lbl.position = Vector2(PAD_X + 54.0, NAME_Y)
		name_lbl.size = Vector2(LEFT_W - 54.0, NAME_H)
		...
		rar_lbl.position = Vector2(PAD_X + 54.0, RARITY_Y)
		rar_lbl.size = Vector2(LEFT_W - 54.0, RARITY_H)
